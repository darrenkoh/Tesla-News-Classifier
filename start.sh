...
docker run --name tesla_classifier -p 8888:8888 -e JUPYTER_ENABLE_LAB=yes -v /Users/darrenkoh/project/Tesla-News-Classifier:/home/jovyan/work jupyter/scipy-notebook
